# -*- coding: mbcs -*-
typelib_path = 'C:\\Program Files\\WindowsApps\\Microsoft.Office.Desktop_16051.12827.20336.0_x86__8wekyb3d8bbwe\\VFS\\ProgramFilesCommonX86\\Microsoft Shared\\VBA\\VBA6\\VBE6EXT.OLB'
...
__all__ = [ 'vbext_ct_ClassModule', 'vbext_rk_TypeLib',
           'vbextFileTypeClass', 'vbext_pt_HostProject',
           'vbext_cv_ProcedureView', 'CodePane', 'VBE',
           'vbext_pk_Let', '_VBComponentsEvents', '_LinkedWindows',
           'Events', 'vbext_vm_Break', 'vbextFileTypeFrx',
           'vbext_wt_ToolWindow', 'Component',
           'vbextFileTypeDesigners', 'VBComponent', '_Properties',
           'vbext_WindowType', 'vbext_wt_ProjectWindow',
           '_Components', 'vbext_rk_Project', 'SelectedComponents',
           'vbext_RefKind', 'vbext_wt_LinkedWindowFrame',
           '_References', '_VBComponents_Old',
           'vbext_cv_FullModuleView', '_ReferencesEvents',
           'vbext_wt_Locals', 'vbext_pk_Proc', '_VBComponent_Old',
           'vbext_ct_StdModule', 'vbext_ws_Maximize', 'CodeModule',
           'vbextFileTypeProject', '_Windows', 'AddIn',
           'vbext_pt_StandAlone', 'vbextFileTypeRes',
           'vbextFileTypePropertyPage', 'vbextFileTypeBinary',
           'vbextFileTypeDocObject', 'vbext_WindowState',
           'vbextFileTypeGroupProject', '_CodePanes',
           '_dispVBComponentsEvents', '_VBProject', 'vbext_ProcKind',
           'vbext_wt_CodeWindow', 'vbextFileTypeForm',
           'vbext_pp_none', 'ProjectTemplate', 'vbext_wt_Watch',
           '_CodePane', 'vbext_wt_Browser', 'vbext_pk_Get',
           'vbextFileTypes', 'vbext_ProjectProtection', 'Property',
           'vbext_ct_MSForm', 'vbextFileTypeExe', 'vbext_pk_Set',
           'vbextFileTypeUserControl', 'References',
           '_dispVBProjectsEvents', 'VBComponents', 'Application',
           'Windows', 'vbext_ProjectType', '_AddIns', 'vbext_vm_Run',
           'Reference', '_dispCommandBarControlEvents', 'CodePanes',
           'vbext_CodePaneview', 'vbext_ct_ActiveXDesigner',
           '_CommandBarControlEvents', 'ReferencesEvents',
           'vbext_wt_Find', 'vbext_wt_PropertyWindow', '_CodeModule',
           'vbext_ws_Normal', '_VBProjects_Old', '_VBComponents',
           'vbext_wt_Toolbox', 'VBProject', 'vbext_VBAMode',
           'vbextFileTypeModule', 'vbext_wt_Immediate', '_Component',
           'vbext_wt_MainWindow', '_dispReferences_Events',
           'LinkedWindows', 'vbext_wt_Designer',
           'vbext_wt_FindReplace', '_VBComponent', 'Properties',
           'CommandBarEvents', '_Windows_old', 'vbext_pp_locked',
           '_dispReferencesEvents', 'Components', '_ProjectTemplate',
           'Window', 'vbext_ct_Document', 'vbext_ComponentType',
           '_VBProjectsEvents', 'VBProjects', 'Addins',
           'vbext_vm_Design', 'vbext_ws_Minimize', '_VBProject_Old',
           '_VBProjects']
from comtypes import _check_version; _check_version('1.1.11', 1533967160.8757439)
